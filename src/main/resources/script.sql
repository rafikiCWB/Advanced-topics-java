...
/* CONSTRAINT é uma palavra reservada que define uma restrição/regra
   para a tabela, como chave primária (PRIMARY KEY) e campos únicos (UNIQUE).
   Aqui são definidas duas constraints:
   - pk_ncn_idnacionalidade: chave primária na coluna idnacionalidade
   - un_ncn_nome: valores únicos na coluna nome */
