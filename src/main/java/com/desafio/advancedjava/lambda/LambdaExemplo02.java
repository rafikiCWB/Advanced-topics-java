...
/**
 * Lambda Expression são Formas de escrever códigos mais funcionais e otimizados. São funções anônimas, ou seja, que não tem nome e não pertencem diretamente a nenhuma class. Lambda Expression introduziu um novo operador à linguagem java, conhecido por arrow ->. Lambda Expressions podem conter argumentos na sua declaração.
 */
